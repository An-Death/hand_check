...
# mpct = Table('mantis_project_check_table', meta,
#              Column('id', Integer, ForeignKey('id'), primary_key=True, nullable=False),
#              Column('need', Integer),
#              Column('user', Integer, ForeignKey('user')),
#              Column('time', Integer)
#              )
# mpt = Table('mantis_project_table', meta,
#             Column('id', Integer, primary_key=True, nullable=False, autoincrement=True),
#             Column('name', String(128)),
#             Column('status', Integer),
#             Column('enabled', Integer),
#             Column('view_state', Integer),
#             Column('access_min', Integer),
#             Column('file_path', String(250)),
#             Column('description', String),
#             Column('category_id', Integer),
#             Column('inherit_global', Integer),
#             Column('priority', Integer),
#             Column('network_id', Integer)
#             )
# mut = Table('mantis_user_table', meta,
#             Column('id', Integer, primary_key=True, nullable=False, autoincrement=True),
#             Column('username', String(32)),
#             Column('realname', String(64)),
...
#             Column('lost_password_request_count', Integer),
#             Column('failed_login_count', Integer),
#             Column('cookie_string', String(64)),
#             Column('last_visit', Integer),
#             Column('date_created', Integer)
#             )
# # Client base project table
# cbpt = Table('cb_data42', meta,
#              Column('id', Integer, primary_key=True, nullable=False, autoincrement=True),
#              Column('user_id', Integer),
#              Column('add_time', TIMESTAMP),
#              Column('status', Integer),
#              Column('f435', String(255)),  # Name
#              Column('f438', Integer),  # -hz
#              Column('f439', String(255)),  # description
#              Column('f440', String(255)),  # address
#              Column('f441', String(255)),  # telphone
#              Column('f442', String(255)),  # email
#              Column('f443', Integer),  # -hz
#              Column('f444', String),  # www.site
#              Column('f445', String),  # company way description/ additional information
#              Column('f446', String(255)),  # -EMPTY
#              Column('f552', String(43)),  # company typo (Подрядчик/Поставщик оборудования)
#              Column('f770', String(255)),  # type of service description/ short info
#              Column('f772', String(35)),  # type of service (ГТИ/ЗТС)
#              Column('f884', String(255)),  # -EMPTY
#              Column('f895', Integer),  # -hz
#              Column('f1047', String(255)),  # mail index + address
#              Column('f1056', String(255)),  # INN ?
#              Column('f1057', String(255)),  # -hz
#              Column('f1058', String(255)),  # bank account
#              Column('f1059', String(255)),  # bank account too ?
#              Column('f1060', String(255)),  # bank comment
#              Column('f1061', String(255)),  # -hz
#              Column('f1062', String(255)),  # some names (who cares??)
#              Column('f1063', String(255)),  # same names
#              Column('f1064', String),  # -hz
#              Column('f1065', String(255)),  # bank name
#              Column('f1088', Integer),  # -hz
#              Column('f1089', String(6)),  # -hz (boolean)
#              Column('f1460', Integer),  # -hz
#              Column('f1470', String(255)),  # -EMPTY
#              Column('f1480', Integer),  # -hz
#              Column('f3441', String(255)),  # short name / shortcut
#              Column('f4271', String),  # some files (contracts)
#              Column('f4620', String),  # other docs
#              Column('f5090', String),  # logo jpg
#              Column('f5970', String),  # address again
#              Column('f6410', Integer),  # -hz
#              Column('f8340', DECIMAL(10, 0)),  # -hz
#              Column('f8360', TIMESTAMP),  # date of last Hand check
#              Column('f8650', Integer),  # -hz
#              Column('f8690', String),  # -hz some official doc BKE
#              Column('f8700', String),  # -hz continue doc
#              Column('f10760', Integer),  # -hz
#              Column('f10910', String),  # HTML + CSS code of main paige with ref's
#              Column('f10930', String),  # doc's again
#              Column('f10940', String),  # -EMPTY
#              Column('f13120', String(255)),  # name of charge
#              Column('f13130', String(255)),  # charge position (director)
#              Column('f14050', String),  # TP ref's
#              Column('r', Integer),  # -hz
#              Column('u', Integer),  # -hz
#              Column('uniq_qst', String(255)),  # -hz
#              )
# # Client base user table
# cbut = Table('cb_users', meta,
#              Column('id', Integer, primary_key=True, nullable=False, autoincrement=True),
...
#              Column('date_registr', DateTime),
#              Column('arc', Integer),
#              Column('group_id', Integer),
#              Column('lang', String(30)),
#              Column('time_zone', String(255)),
#              Column('window_scroll', Integer),
#              Column('default_page', String(30)),
#              Column('developer_mode', Integer),
#              Column('user_hash', String(255)),
#              Column('last_time', DateTime),
#              Column('last_event', DateTime),
#              Column('last_ip', String(255)),
#              Column('ot_key', String),
#              Column('crypt_mode', String(255)),
#              Column('t', Integer),
#              Column('sound_on', Integer),
#              Column('cut_notify_String', Integer),
#              Column('oktell_login', String(255)),
#              Column('oktell_password', String(255)),
#              Column('oktell_use_handsfree', Integer),
#              Column('asterisk_login', String(255)),
#              Column('asterisk_password', String(255)),
#              Column('asterisk_use_handsfree', Integer),
#              Column('asterisk_number', String(255)),
#              Column('display_notification_on', Integer),
#              )
